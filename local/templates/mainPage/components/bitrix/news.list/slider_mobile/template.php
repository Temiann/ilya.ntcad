                ...
                <div class="swiper-slide main-slider__slide">
                    <div class="main-slider__slide-bg mobile bg-bg-bg">
                        <picture class="picture">
                            <img class="picture__img" src="<?=$item['MOBILE_IMG']['src']?>">
                        </picture>
                    </div>
                    <div class="main-slider__content">
                        <div class="main-slider__content-first">
                            <div class="main-slider__content-icon">
                                ...
                                <?elseif (empty($item["STICKER"])):?>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="70" viewbox="0 0 100 70" fill="none">
                                    </svg>
                                <?endif;?>
                            </div>
                            <div class="main-slider__content-title"><?=$item["NAME"]?></div>
                        </div>
                        <div class="main-slider__content-second">
                            <div class="main-slider__content-desk"><?=$item["DESCRIPTION"]?></div>
                            <div class="main-slider__content-bot"><a class="main-slider__content-button" href="<?=($_SERVER["DOCUMENT_ROOT"] . SITE_TEMPLATE_PATH . $item["HREF_STR"])?>">
                                    <p><?=$item["ABOUT"]?>></p>
                                </a></div>
                        </div>
                    </div>
